...
See 
![An overview on how we were able to extract biologically relevent information from ICD-O-3 codes, the problems we encountered and the type of information we were able to extract.](./biohackaton_slide.png)
